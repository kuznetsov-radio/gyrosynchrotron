...
class Std_DF : public DF
{
 ...
 void FE(double E, double mu, 
	     double *f, double *df_dE, double *df_dmu, 
		 double *g1, double *g2);
 Std_DF(double ne, double *ParmIn, int k, int *OK, int *empty, int *kap_on, int *Done);
 ~Std_DF();
};
...
class Arr_DF : public DF
{
 ...
 void FE(double E, double mu, 
	     double *f, double *df_dE, double *df_dmu, 
		 double *g1, double *g2);
 Arr_DF(double *ParmIn, int InSize, int N_E, int N_mu, double *E, double *mu, IDL_DFarr *f3D, int *OK, int *empty);
 ~Arr_DF();
};